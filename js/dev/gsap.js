...
const animateText = (selector3, delay, y = 100, staggerAmount = 0.5, rotationRange = [-60, 60], opacity = 0) => {
  const splitText = SplitText.create(selector3, { type: "chars" });
  gsapWithCSS.from(splitText.chars, {
    opacity,
    delay,
    y,
...
document.fonts.ready.then(() => {
  ...
  animateText(".bta-main-title", 0.85, 0, 1, [-60, 60]);
  animateText(".bta-main-text", 1.25, 100, 0.75, [-60, 60]);
});
